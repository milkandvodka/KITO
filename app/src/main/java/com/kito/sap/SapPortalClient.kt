...
////class SapPortalClient {
////
////    // Mock client that doesn't actually make network requests
////    // private val client = OkHttpClient.Builder()
////    //     .cookieJar(PersistentCookieJar())
////    //     .connectTimeout(30, TimeUnit.SECONDS)
////    //     .readTimeout(30, TimeUnit.SECONDS)
...
////    suspend fun fetchAttendance(username: String, password: String, academicYear: String = "", termCode: String = ""): AttendanceResult = withContext(Dispatchers.IO) {
////        return@withContext try {
////            // Simulate the same logging as the real implementation
////            println("🌐 Fetching mock attendance data...")
////
////            // Skip actual login flow and return mock data directly
////            println("✅ Mock login successful.")
////            println("🔄 Mocking Navigation Events...")
////            println("✅ Mock Navigation Events successful.")
////            println("🔑 Mock tokens extracted.")
////
////            // Simulate network delay to mimic real response time
////            kotlinx.coroutines.delay(1500)
////
////            // Create mock attendance data similar to what the real SAP portal would return
////            val mockAttendance = AttendanceData(
////                subjects = listOf(
////                    SubjectAttendance(
////                        subjectCode = "CSE101",
...
////                        totalClasses = 48,
////                        percentage = 87.5,
////                        facultyName = "Prof. Alice Williams"
////                    ),
////                    SubjectAttendance(
////                        subjectCode = "PHY301",
...
////                        totalClasses = 30,
////                        percentage = 83.3,
////                        facultyName = "Dr. Michael Wilson"
////                    )
////                )
////            )
////
////            println("✅ Mock attendance data fetched successfully.")
////
////            // Skip actual logout since we're not making real requests
////            AttendanceResult.Success(mockAttendance)
////
////        } catch (e: IOException) {
////            println("❌ Mock IOException during network request: ${e.message}")
////            e.printStackTrace()
////            AttendanceResult.Error("Mock Network error: ${e.message ?: e.javaClass.simpleName}")
////        } catch (e: Exception) {
////            println("❌ Mock general error during attendance fetch: ${e.message}")
////            e.printStackTrace()
////            val errorMessage = if (e.message?.contains("No attendance rows parsed") == true) {
////                "Mock: No attendance data available for the selected year and session. Please check your year/session selection and try again."
////            } else {
////                "Mock Error: ${e.message ?: e.javaClass.simpleName}"
////            }
////            AttendanceResult.Error(errorMessage)
////        }
////    }
////
////    private fun createFormBody(params: Map<String, String>): RequestBody {
////        // This method exists to maintain compatibility with other code that might call it
////        val formBuilder = FormBody.Builder()
////        for ((key, value) in params) {
////            formBuilder.add(key, value)
////        }
...
////    private fun performLogout() {
////        // This method exists to maintain compatibility with other code that might call it
////        // In the mock version, it does nothing
////        println("✅ Mock logout completed.")
////    }
////}
////
////sealed class AttendanceResult {
